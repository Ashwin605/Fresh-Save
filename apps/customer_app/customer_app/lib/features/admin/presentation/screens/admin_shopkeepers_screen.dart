...
import '../providers/admin_shopkeepers_provider.dart';

class AdminShopkeepersScreen extends ConsumerWidget {
  const AdminShopkeepersScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final dataAsync = ref.watch(adminShopkeepersProvider(const {'page': 1, 'limit': 20}));
