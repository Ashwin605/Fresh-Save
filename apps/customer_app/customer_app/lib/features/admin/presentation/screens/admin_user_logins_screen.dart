...
import '../providers/admin_login_stats_provider.dart';

class AdminUserLoginsScreen extends ConsumerWidget {
  const AdminUserLoginsScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final dataAsync = ref.watch(adminLoginStatsProvider(const {'page': 1, 'limit': 20}));
