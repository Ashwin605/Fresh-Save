            ...
            child: ListView(
              ...
              children: [
                ...
                _NavItem(
                  ...
                  route: '/admin/user-logins',
                  isSelected: currentRoute == '/admin/user-logins',
                ),
                const SizedBox(height: AppSpacing.xs),
                _NavItem(
                  title: 'Stores',
                ...
                _NavItem(
                  ...
                  isSelected: currentRoute == '/admin/shopkeepers',
                ),
                const SizedBox(height: AppSpacing.xs),
                _NavItem(
                  title: 'Categories',
                ...
                _NavItem(
                  ...
                  isSelected: currentRoute == '/admin/inventory',
                ),
                const SizedBox(height: AppSpacing.xs),
                _NavItem(
                  ...
                  isSelected: currentRoute == '/admin/stock-transfers',
                ),
                const SizedBox(height: AppSpacing.xs),
                _NavItem(
                  title: 'Packages',
                ...
                _NavItem(
                  ...
                  isSelected: currentRoute == '/admin/discounts',
                ),
                const SizedBox(height: AppSpacing.xs),
                _NavItem(
                  title: 'Coupons',
